...
namespace Dreamyi12\ApiDoc\Swagger;
...
use Dreamyi12\ApiDoc\Controller\BaseController;
use Dreamyi12\ApiDoc\Controller\ControllerInterface;
use Hyperf\Contract\ConfigInterface;
use Hyperf\Server\Exception\RuntimeException;
use Hyperf\Utils\ApplicationContext;
use Dreamyi12\ApiDoc\Helpers\ArrayHelper;
use Dreamyi12\ApiDoc\Helpers\ConvertHelper;
use Dreamyi12\ApiDoc\Helpers\DirectoryHelper;
use Dreamyi12\ApiDoc\Helpers\FileHelper;
...
class Swagger
{
    ...
    public function addPath(string $className, string $methodName, string $path, $version = null): void
    {
        ...
        /** @var \Dreamyi12\ApiDoc\Annotation\Methods $reqMethod */
        $reqMethod = null;
