...
return [
    ...
    'api'     => [
        //是否显示具体的参数错误,生产环境可关闭
        'show_params_detail_error' => env('APP_DEBUG', true),
    ...
    //swagger文档配置
    'swagger' => [
        'output_json'         => env('API_DOC', true), // 是否生成json文件,以供swagger-ui使用;开发环境打开,为true;生产环境关闭,为false.
...
EOF,
        ...
        'host'                => env('APP_URL', '192.168.0.110:577'), //站点域名或URL
        'basePath'            => '/', //接口基础路径,可不改
        'schemes'             => ['http'], //协议
        'securityDefinitions' => [
            'jwt' => [
